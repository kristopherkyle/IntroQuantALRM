...
The results of Levene's test indicate that there is not a significant difference in the variance across our three proficiency groups, which means that our data meets this assumption.
